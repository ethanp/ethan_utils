...
extension NumExtensions on num {
  ...
  String get asCompactCount {
    ...
    final absolute = abs();
    if (absolute >= 1000000) {
      return '$sign${_oneDecimalKiloOrMegaCoefficient(absolute / 1000000)}M';
    }
    if (absolute >= 1000) {
      return '$sign${_oneDecimalKiloOrMegaCoefficient(absolute / 1000)}k';
    }
...
String _oneDecimalKiloOrMegaCoefficient(num scaled) {
